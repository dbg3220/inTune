...
public class LessonControllerTest {
    ...
    public void testGetLessons() throws IOException { // getLessons may throw IOException
        // Setup
        User testuser1 = new User(5000, "Test1", "Test1", null, null, null, null, 0, 0, null, null, false);
        User testuser2 = new User(100, "Test2", "Test2", null, null, null, null, 0, 0, null, null, false);
        Lesson[] lessons = new Lesson[2];
        lessons[0] = new Lesson(99, "Viola", 122.99, Product.Category.WOODWINDS, 1, false, false, true,
        "John Doe", testuser1, Lesson.Day.Monday, "12:00", false);
        lessons[1] = new Lesson(99, "Viola", 122.99, Product.Category.WOODWINDS, 1, false, false, true,
        "John Doe", testuser2, Lesson.Day.Monday, "12:00", false);
